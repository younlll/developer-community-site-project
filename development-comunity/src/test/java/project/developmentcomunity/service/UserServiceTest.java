...
class UserServiceTest {
    ...
    void 회원번호_채번() {
        ...
        assertThat(userService.findById(userId).isPresent()).isEqualTo(false);
    }
    ...
    void 회원가입() {
        ...
        joinForm.setEmail("youn.lee96@gmail.com");
        joinForm.setName("이유나");
        joinForm.setNickName("youuuu");
        joinForm.setPassword("1q2w3e4r!");
        userService.joinUser(joinForm);

        assertThat(userService.findByEmail(joinForm.getEmail())).isEqualTo(true);
    }
